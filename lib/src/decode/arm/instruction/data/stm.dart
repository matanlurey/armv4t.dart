...
/// Store Multiple.
///
/// The [STM] instruction permits block moves of registers to memory and
...
///   start_address <- Rn
///   for i = 0 to 15
///     if (regsiter_list[i] == 1)
///       memory[next_address] <- Ri
///   if (writeback)
///     Rn <- end_address
/// ```
///
/// > NOTE: There are two distinct variations of the [STM] instruction. One of
